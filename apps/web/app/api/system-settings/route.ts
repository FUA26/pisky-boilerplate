...
export const PUT = protectApiRoute({
  ...
  handler: async (req) => {
    try {
      ...
      const siteLogoId =
        validatedData.siteLogoId === "" ? null : validatedData.siteLogoId
      const heroBackgroundId =
        validatedData.heroBackgroundId === ""
          ? null
          : validatedData.heroBackgroundId
      const socialFacebook =
        validatedData.socialFacebook === ""
          ? null
          : validatedData.socialFacebook
      const socialTwitter =
        validatedData.socialTwitter === "" ? null : validatedData.socialTwitter
      const socialInstagram =
        validatedData.socialInstagram === ""
          ? null
          : validatedData.socialInstagram
      const socialYouTube =
        validatedData.socialYouTube === "" ? null : validatedData.socialYouTube
      ...
      const settings = await prisma.systemSettings.upsert({
        ...
        create: {
          ...
          emailVerificationExpiryHours:
            validatedData.emailVerificationExpiryHours,
